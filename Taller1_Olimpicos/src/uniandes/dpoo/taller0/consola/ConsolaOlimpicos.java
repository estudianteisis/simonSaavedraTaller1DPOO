...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar pa�s de un atleta\n");
	}
	...
	private void ejecutarEncontrarAtletaNombre() 
	{
		String atleta = input("Por favor ingrese el nombre de un atleta");
		System.out.println("\n" + "Pa�s que atleta consultado representa:" + "\n");

		String pais = calculadora.encontrarPais(atleta).darNombre();
